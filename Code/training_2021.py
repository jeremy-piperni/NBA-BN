...
# Get the 2021-2022 games dataset
script_dir = os.path.dirname(os.path.abspath(__file__))
new_path = os.path.join(script_dir, os.pardir, "Data/Cleaned/Team Stats", "2021-2022_Games.csv")
new_path = os.path.abspath(new_path)
df_games_2021 = pd.read_csv(new_path)

# Prepare the 2021-2022 training data
df_games_2021 = df_games_2021.rename(columns={"Away":"Team"})
df_train_2021 = df_games_2021.merge(df_2020, on="Team", how="left")
df_train_2021 = df_train_2021.rename(columns={
    "Team": "Away",
    "Wins": "Away_Wins_Last"
})
df_train_2021 = df_train_2021.rename(columns={"Home":"Team"})
df_train_2021 = df_train_2021.merge(df_2020, on="Team", how="left")
df_train_2021 = df_train_2021.rename(columns={
    "Team": "Home",
    "Wins": "Home_Wins_Last"
})
df_train_2021 = df_train_2021[["Home","Away","Home_Wins_Last","Away_Wins_Last","Game_Outcome"]]
df_train_2021 = df_train_2021.rename(columns={"Away":"Team"})
df_train_2021 = df_train_2021.merge(df_2019, on="Team", how="left")
df_train_2021 = df_train_2021.rename(columns={
    "Team": "Away",
...
df_train_2021 = df_train_2021[["Home","Away","Home_Wins_Last","Away_Wins_Last","Home_Wins_Second_Last","Away_Wins_Second_Last","Game_Outcome"]]
df_train_2021 = df_train_2021.rename(columns={"Away":"Team"})
df_train_2021 = df_train_2021.merge(df_2018, on="Team", how="left")
df_train_2021 = df_train_2021.rename(columns={
    "Team": "Away",
